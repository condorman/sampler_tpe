...
const internals = {
  ...
  CONSTRAINTS_KEY,
  FIXED_PARAMS_KEY,
  STUDY_SNAPSHOT_MAGIC,
  STUDY_SNAPSHOT_VERSION,
  SPECIAL_NUMBER_MARKER,
  FUNCTION_SPEC_KIND,
  isPlainObject,
  encodeNumberForSnapshot,
  decodeNumberFromSnapshot,
  cloneJsonValue,
  serializeJsonValueForSnapshot,
  deserializeJsonValueFromSnapshot,
  serializeDistributionForSnapshot,
  deserializeDistributionFromSnapshot,
  serializeRngStateForSnapshot,
  restoreRngStateFromSnapshot,
  serializeFunctionSpec,
  resolveFunctionSpec,
  serializeOptionalFunctionSpec,
  resolveOptionalFunctionSpec,
  serializeCategoricalDistanceSpec,
  resolveCategoricalDistanceSpec,
  ...
  compareRowsLex,
  uniqueSortedRowsWithInverse,
  getMsb,
  heapSortArgSegment,
  numpyQuickArgSort,
  randomChoiceIndicesByWeights,
  MT19937,
  adjustDiscreteUniformHigh,
  adjustIntUniformHigh,
  FloatDistribution,
  IntDistribution,
  CategoricalDistribution,
  transformNumericalParam,
  untransformNumericalParam,
  randomSampleFromDistribution,
  RandomSampler,
  SearchSpaceGroup,
  ...
  isParetoFront2D,
  isParetoFrontND,
  isParetoFrontForUniqueSorted,
  isParetoFront,
  calculateNondominationRank,
  fastNonDominationRank,
  compute2dHypervolume,
  compute3dHypervolume,
  computeHvRecursive,
  computeExclusiveHv,
  computeHypervolume,
  solveHssp2d,
  lazyContribsUpdate,
  solveHsspOnUniqueLossVals,
  solveHssp,
  getReferencePoint,
  splitCompleteTrialsSingleObjective,
  splitCompleteTrialsMultiObjective,
  splitCompleteTrials,
  getPrunedTrialScore,
  splitPrunedTrials,
  getInfeasibleTrialScore,
  splitInfeasibleTrials,
  splitTrials,
  calculateWeightsBelowForMultiObjective,
  processConstraintsAfterTrial,
  TPESampler,
  TrialRuntime,
  createFrozenTrial,
  Study,
